...
import '../model/Contato_api.dart';

class ContatosEditApiPage extends StatefulWidget {
  const ContatosEditApiPage({super.key, this.selecionado});

  final ContatoApi? selecionado;

  @override
  State<ContatosEditApiPage> createState() => _ContatosEditApiPageState();
}

class _ContatosEditApiPageState extends State<ContatosEditApiPage> {
